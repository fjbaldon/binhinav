...
import { getMerchantProfile, updateMerchantProfile } from "@/api/merchants";
...
export default function MerchantProfilePage() {
    ...
    useEffect(() => {
        document.title = "Profile | Binhinav Merchant";
    }, []);
            ...
            <Card>
                <form onSubmit={form.handleSubmit(onSubmit)} autoComplete="off">
                    <CardHeader>
                        ...
                        <CardDescription>
                            This is your name as it appears to administrators.
                        </CardDescription>
                    </CardHeader>
